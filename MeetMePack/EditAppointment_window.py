...
from MeetMePack.EditAppointment_window_actions import *
...
def open_edit_appointment_local_appointment(conn, root, new_window2, appointment):
    ...
    new_window3.iconbitmap("MeetMe_icon.ico")
    ...
    code_value = customtkinter.CTkEntry(new_window3, width = 150, corner_radius = 50)
    ...
    date_value = customtkinter.CTkEntry(new_window3, width = 150, corner_radius = 50)
    ...
    start_value = customtkinter.CTkEntry(new_window3, width = 150, corner_radius = 50)
    ...
    end_value = customtkinter.CTkEntry(new_window3, width = 150, corner_radius = 50)
    ...
    during_value = customtkinter.CTkEntry(new_window3, width = 150, corner_radius = 50)
    ...
    id_client_value = customtkinter.CTkEntry(new_window3, width = 150, corner_radius = 50)
    ...
    name_client_value = customtkinter.CTkEntry(new_window3, width = 150, corner_radius = 50)
    ...
    surname_client_value = customtkinter.CTkEntry(new_window3, width = 150, corner_radius = 50)
    ...
    phone_client_value = customtkinter.CTkEntry(new_window3, width = 150, corner_radius = 50)
    ...
    email_client_value = customtkinter.CTkEntry(new_window3, width = 150, corner_radius = 50)
    ...
    save_button = customtkinter.CTkButton(new_window3, 
                                          ...
                                          width = 30, 
                                          height = 30,
                                          command=lambda: save_edit_rantevou_local(conn, code_value, date_value, start_value, during_value, end_value, new_window2))
