...
from MeetMePack.EditClientAppointment_window_actions import *
...
def open_edit_appointment(conn, root, new_window2, appointment, id_value, name_value, surname_value):
    ...
    new_window4.iconbitmap("MeetMe_icon.ico")
    ...
    code_value = customtkinter.CTkEntry(new_window4, width = 150, corner_radius = 50)
    ...
    date_value = customtkinter.CTkEntry(new_window4, width = 150, corner_radius = 50)
    ...
    start_value = customtkinter.CTkEntry(new_window4, width = 150, corner_radius = 50)
    ...
    end_value = customtkinter.CTkEntry(new_window4, width = 150, corner_radius = 50)
    ...
    during_value = customtkinter.CTkEntry(new_window4, width = 150, corner_radius = 50)
