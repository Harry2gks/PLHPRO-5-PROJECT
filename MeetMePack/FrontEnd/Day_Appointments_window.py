from MeetMePack.ConnectBackFrontEnd.Day_Appointments_window_actions import *
from MeetMePack.FrontEnd.EditAppointment_window import *
...
def search_appointment_by_day_local(conn, root, search_entry):
    ...
    new_window2.iconbitmap(resource_path("icons\\MeetMe_icon.ico"))
    ...
    if appointment == 0:
        ...
        for i, appointment in enumerate(appointment):
            ...
            # ------------------------------------- BUTTONS -------------------------------------------------------------
            edit_rantevou_icon =  customtkinter.CTkImage(dark_image=Image.open(resource_path("icons\\icons8-edit-48.png")),
            ...
            del_rantevou_icon = customtkinter.CTkImage(dark_image=Image.open(resource_path("icons\\icons8-trash-48.png")),
        ...
        export_button_icon = customtkinter.CTkImage(dark_image=Image.open(resource_path("icons\\icons8-export-excel-48.png")),
                                                    light_image=Image.open(resource_path("icons\\icons8-export-excel-48.png")),
                                                    size = (30,30))
        ...
        email_button_icon = customtkinter.CTkImage(dark_image=Image.open(resource_path("icons\\icons8-send-email-48.png")),
                                                   light_image=Image.open(resource_path("icons\\icons8-send-email-48.png")),
                                                   size = (30,30))
