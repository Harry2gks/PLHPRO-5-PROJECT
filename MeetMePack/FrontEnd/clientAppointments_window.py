from MeetMePack.ConnectBackFrontEnd.clientAppointments_window_actions import *
from MeetMePack.FrontEnd.EditClientAppointment_window import *
    ...
    if id_value.get() != "":
        ...
        if rantevou == 0:
            ...
            for i, appointment in enumerate(rantevou):
                ...
                delete_rantevou_icon = customtkinter.CTkImage(dark_image=Image.open(resource_path("icons\\icons8-trash-48.png")),
