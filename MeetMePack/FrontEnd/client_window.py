from MeetMePack.ConnectBackFrontEnd.client_window_actions import *
from MeetMePack.FrontEnd.New_Appointment_window import *
...
def client_list(conn, root):
    ...
    phone_search_icon = customtkinter.CTkImage(dark_image=Image.open(resource_path("icons\\mobile-search.png")),
                                               light_image=Image.open(resource_path("icons\\mobile-search.png")),
                                               size = (30,30))
    ...
    email_search_icon = customtkinter.CTkImage(dark_image=Image.open(resource_path("icons\\icons8-search-in-mail-48.png")),
                                               light_image=Image.open(resource_path("icons\\icons8-search-in-mail-48.png")),
                                               size = (30,30))
    ...
    new_client_icon = customtkinter.CTkImage(dark_image=Image.open(resource_path("icons\\icons8-new-contact-48.png")),
                                             light_image=Image.open(resource_path("icons\\icons8-new-contact-48.png")),
                                             size = (30,30))
    ...
    edit_button_icon = customtkinter.CTkImage(dark_image=Image.open(resource_path("icons\\icons8-edit-48.png")),
                                              light_image=Image.open(resource_path("icons\\icons8-edit-48.png")),
                                              size = (30,30))
    ...
    delete_button_icon = customtkinter.CTkImage(dark_image=Image.open(resource_path("icons\\icons8-trash-48.png")),
                                                light_image=Image.open(resource_path("icons\\icons8-trash-48.png")),
                                                size = (30,30))
    ...
    appointments_button_icon = customtkinter.CTkImage(dark_image=Image.open(resource_path("icons\\icons8-calendar-48.png")),
                                                      light_image=Image.open(resource_path("icons\\icons8-calendar-48.png")),
                                                      size = (30,30))
    ...
    # Load the image for the appointments button icon
    new_appointment_button_icon = customtkinter.CTkImage(dark_image=Image.open(resource_path("icons\\icons8-calendar-plus-48.png")),
                                                         light_image=Image.open(resource_path("icons\\icons8-calendar-plus-48.png")),
                                                         size = (30,30))
