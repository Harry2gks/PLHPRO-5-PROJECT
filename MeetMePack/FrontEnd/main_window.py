...
from MeetMePack.BackEnd.database import run
from MeetMePack.FrontEnd.client_window import *
from MeetMePack.FrontEnd.appoinment_window import *
import webbrowser
...
root = tk.Tk()
root.title("Meet Me")
root.iconbitmap(resource_path("icons\\MeetMe_icon.ico"))
