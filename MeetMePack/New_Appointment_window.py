...
from MeetMePack.New_Appointment_window_actions import *
...
def open_appointment(conn, root, id_value, name_value, surname_value, search_value, anti_search_value):
    ...
    if id_value.get() != "":
     ...
     # --------------------------- BUTTONS --------------------------------------------
        ...
        discard_rantevou_button_icon = customtkinter.CTkImage(dark_image=Image.open("MeetMe 2.0/icons/icons8-trash-48.png"),
